...
**Inventory Management** – Administrators can add, update, and manage book stock.
**Delivery Management** – Assign and monitor book deliveries efficiently.
**Order Management Dashboard** – Manage customer orders, payments, and delivery status.
**Search and Filtering** – Quickly find books using search and filtering options.
**Notifications & Updates** – Receive order confirmation and delivery status updates.


**NPM Packages Used**: Next.js, React, Tailwind CSS, Express.js, MongoDB, Cors, Dotenv, Stripe, React Icons, SweetAlert2, and Axios/Fetch API for frontend-backend communication.
